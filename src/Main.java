...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        BigInteger p = cipherInput.getP();
        BigInteger q = cipherInput.getP();
        BigInteger n = cipherInput.getN(p, q);
        ...
        buttonInput.setOnAction(e -> {//tutaj beda rzeczy co sie beda dzialy po wcisnieciu guzika ktory zwie sie button imput
            ...
            BigInteger[] cipheredBI = cipherInput.cipher(plain, n);
        ...
        buttonFile.setOnAction(e -> {
            ...
            BigInteger[] zaszyfrowany = cipherInput.cipher(fileContent, n);
